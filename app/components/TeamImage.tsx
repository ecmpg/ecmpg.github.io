...
export default function TeamImage() {
  ...
  return (
    <section id="partners" className="py-14 md:py-0">
      <div className="">
        ...
        <div className="grid gap-0 md:grid-cols-1 lg:grid-cols-1 mt-0">
          <div className="relative">
            <div
              className="left-0 right-0 w-full h-[450px] rounded-t-6xl shadow-2xl mx-auto overflow-hidden z-10 parallax-bg bg-cover bg-top bg-no-repeat"
